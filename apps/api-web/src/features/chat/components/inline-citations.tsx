...
export function RenderTextWithCitations({ text, sources, keyPrefix }: RenderTextWithCitationsProps): ReactNode {
  if (sources.length === 0) {
    return (
      <MessageResponse parseIncompleteMarkdown>{text}</MessageResponse>
    )
  }
