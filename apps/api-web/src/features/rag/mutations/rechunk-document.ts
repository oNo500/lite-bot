...
export type RechunkResult = { ok: true } | { ok: false; reason: "not-found" | "no-raw-content" };
...
export async function rechunkDocument(params: RechunkDocumentParams): Promise<RechunkResult> {
