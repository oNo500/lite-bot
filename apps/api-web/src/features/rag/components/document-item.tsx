...
const STATUS_CLASS: Record<DocumentStatus, string> = {
  ...
  processing:
    "text-blue-600 border border-blue-200 bg-blue-50 dark:text-blue-400 dark:border-blue-800 dark:bg-blue-950",
  ready:
    "text-green-700 border border-green-200 bg-green-50 dark:text-green-400 dark:border-green-800 dark:bg-green-950",
  ...
  return (
    <div className="flex items-center gap-3 border-b px-4 py-3 transition-colors last:border-b-0 hover:bg-muted/30">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <span
          className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${STATUS_CLASS[doc.status]}`}
        >
