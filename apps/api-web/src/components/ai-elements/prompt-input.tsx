...
const useOptionalPromptInputController = () => use(PromptInputControllerContext);
  ...
  const inner = (
    <>
      ...
      <form className={cn("w-full", className)} onSubmit={handleSubmit} ref={formRef} {...props}>
        <InputGroup className="overflow-hidden rounded-4xl border-none bg-muted p-2 shadow-none">
          {children}
        </InputGroup>
      </form>
    </>
...
export const PromptInputHoverCard = ({
  // openDelay and closeDelay are not supported by the base-ui PreviewCard
